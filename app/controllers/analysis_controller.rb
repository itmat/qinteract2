class AnalysisController < ApplicationController
 ...
 def unzip
   ...
   if ! File.exist?("#{ARCHIVE_ROOT}/archive_#{analysis.id}.tgz")

     flash[:notice] = "Could not restore your analysis because file archive_#{analysis.id}.tgz could not be found.  Please contact your administrator and tell him to add archive_#{analysis.id}.tgz to #{ARCHIVE_ROOT}"     
